      ...
      >
        ...
        >
          <h2 className="text-4xl font-bold mb-4">
            Find <span className="text-[var(--primary-color)]">Us</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="bg-white p-6 rounded-lg shadow-lg mb-8">
              <h3 className="text-2xl font-bold mb-4 text-[var(--primary-color)]">Our Location</h3>
              <div className="flex items-start mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[var(--primary-color)] mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <div>
                  <p className="font-bold">Barber Kartell</p>
                  <p className="text-[var(--black)]">QuezonDrive Multipurpose Hall</p>
                  <p className="text-[var(--black)] ">Camp Dau rd, Mabalacat, Pampanga 2010</p>
                </div>
              </div>
              <div className="flex items-start mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[var(--primary-color)] mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div>
                  ...
                  <p className="text-[var(--black)]">+63 949 796 8797</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-[var(--black)]">gabthebarber@gmail.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg overflow-hidden shadow-lg h-[300px] bg-gray-200 relative">
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-[var(--black)]">Interactive Map Would Be Embedded Here</p>
              </div>
          ...
          >
            <div className="bg-white p-6 rounded-lg shadow-lg mb-8">
              <h3 className="text-2xl font-bold mb-4 text-[var(--primary-color)]">Business Hours</h3>
